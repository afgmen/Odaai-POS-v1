...
class Promotions extends Table {
  ...
  IntColumn get productId => integer().nullable().references(Products, #id)(); // DEPRECATED: B-082 이후 사용 안 함
  BoolColumn get applyToAllProducts => boolean().withDefault(const Constant(true))(); // B-082: 모든 제품에 적용 여부
